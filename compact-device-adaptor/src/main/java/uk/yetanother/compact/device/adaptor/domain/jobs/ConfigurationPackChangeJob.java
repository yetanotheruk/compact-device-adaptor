...
public class ConfigurationPackChangeJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        LocalDateTime scheduledDate = LocalDateTime.parse(context.getJobDetail().getJobDataMap().get("date").toString());
        ...
        configurationPackActionController.scheduledChange(configurationPacks);
    }
